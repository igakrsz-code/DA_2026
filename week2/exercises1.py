...
# >>> 3 == "3"
# False   -> int is not equal to string

# >>> "3" > 3
# TypeError -> you can't compare str and int with >
...
if name == "Iga":
    print("We have the same name! Wooooah!")
else:
    print("We have different names :p")
